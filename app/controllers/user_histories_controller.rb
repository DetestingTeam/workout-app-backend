...
@history = UserHistory.includes(:movement, :workout).where(user_id: params[:id]).pluck_to_hash(:movement_name,:workout_name, :rep, :user_id, :movement_id, :id, :difficulty, :workout_date)
